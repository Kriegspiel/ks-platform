...
ROOT = Path("/home/fil/dev/kriegspiel")
OUTPUT = ROOT / "ks-platform" / "documentation" / "module-index.md"
...
def main() -> None:
    ...
    lines: list[str] = [
        "# Module Index",
        "",
        f"Generated from the checked-out repos under `/home/fil/dev/kriegspiel` on {generated_at}.",
        "",
