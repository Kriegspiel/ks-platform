...
The canonical live-game record is defined in `.../kriegspiel/ks-backend/src/app/models/game.py` as `GameDocument`.
...
Defined in `.../kriegspiel/ks-game/kriegspiel/move.py`.
...
Defined in `.../kriegspiel/ks-backend/src/app/models/user.py`.
...
Bot-specific models live in `.../kriegspiel/ks-backend/src/app/models/bot.py`.
